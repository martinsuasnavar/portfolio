        ...
        <section className="m-20 w-80 sm:w-3/6 ml-auto mr-auto">
          ...
          <article>
            ...
            {backTechArray.map(tech => (
              <a key={tech.name} href={tech.link} className="cursor-pointer m-1 items-center align-center flex flex-col justify-center text-white text-opacity-0 hover:text-opacity-100 transition-transform duration-300 transform hover:scale-105">
                <Image src={tech.imgSrc} alt={`${tech.name} logo`} width={40} height={40}/>
                <div className="text-sm mt-4 align-center">{tech.name}</div>
